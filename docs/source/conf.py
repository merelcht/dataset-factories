...
# dataset_factories documentation build
...
from dataset_factories import __version__ as release

# -- Project information -----------------------------------------------------

project = "dataset_factories"
author = "Kedro"
...
htmlhelp_basename = "dataset_factoriesdoc"
...
latex_documents = [
    (
        master_doc,
        "dataset_factories.tex",
        "dataset_factories Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "dataset_factories",
        "Project dataset_factories codebase.",
        "Data-Science",
    )
]
